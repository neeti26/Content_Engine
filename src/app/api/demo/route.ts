...
export async function POST() {
  const result: GeneratedContent = {
    ...
    instagramPost: {
      caption: "500+ marketing leaders. 3 days. Infinite ideas. 🔥\n\nTechSummit 2026 wasn't just another conference — it was a movement. We dove deep into AI-powered brand activations, measuring experiential ROI, and what it takes to create moments people remember. ✨\n\nThe energy? Unmatched. The insights? Game-changing. The connections? Priceless. 💡\n\nAlready counting down to next year. Who's with us? 🚀",
    ...
    twitter: {
      threadHook: "TechSummit 2026 just wrapped. 500+ marketing leaders. 3 days. Here's what you missed 🧵",
      tweets: [
        "TechSummit 2026 just wrapped.\n\n500+ marketing leaders. 3 days of pure innovation.\n\nHere's what you missed 🧵",
        ...
        "TechSummit 2026 proved one thing:\n\nExperiential marketing isn't dying. It's evolving.\n\nSee you at TechSummit 2026. 🚀\n\n#TechSummit2025 #ExperientialMarketing",
      ],
      selectedImageId: "demo-2",
    },
    whatsapp: {
      statusText: "Just wrapped TechSummit 2026. Mind = blown. 🔥",
      caption: "Just got back from TechSummit 2026 and honestly — this was something else. 500+ marketing leaders, 3 days of real conversations, and ideas that are going to change how we work. If you missed it, let's catch up soon!",
      selectedImageId: "demo-2",
    },
    caseStudy: {
      title: "TechSummit 2026: How StepOne Turned a 3-Day Conference Into a Marketing Movement",
      executiveSummary: "StepOne faced the challenge of creating a flagship event to position them as India's leading experiential marketing authority. TechSummit 2026 delivered: 500+ attendees, 50K+ social impressions, 12 media placements, and 8 co-marketing partnerships.",
      eventOverview: "TechSummit 2026 was designed to answer one question: How can brands create memorable experiences at scale in an AI-powered world? Over three days in Mumbai, 500+ CMOs and marketing innovators gathered to explore the intersection of technology and human connection.\n\nThe summit featured 12 keynote sessions, 8 panel discussions, live product demos, and curated networking experiences. Every touchpoint was intentional — from AI-personalized welcome kits to data-driven session recommendations.",
      keyHighlights: [
      ...
      conclusion: "TechSummit 2026 proved that experiential marketing's future lies at the intersection of AI-powered personalization and authentic human connection. StepOne's next milestone: scaling this model to 5 cities across India in 2026.",
